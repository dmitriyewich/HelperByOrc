...
- Общий PCRE2-конструктор в одной рабочей поверхности строит шаблоны по примеру и выделенным фрагментам; триггеры извлекают именованные и нумерованные группы через `[chatwordsex(...)]`.
...
- Фильтр сообщений по обычному тексту и PCRE2 с автоматическим и ручным конструктором правил.
