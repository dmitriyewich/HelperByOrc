...
Нативный **ASI-плагин** для **GTA San Andreas / SA:MP** (Win32/x86): биндер сценариев, быстрое меню, теги, профильный блокнот, HUD и фильтр сообщений в одном внутриигровом интерфейсе.
...
- Общие для всех профилей переменные из Lua со встроенным LuaJIT и опциональным MoonLoader backend.
...
4. Выберите профиль и настройте язык, масштаб, горячие клавиши и быстрое меню.
