...
- Единая модель блокировок для запуска биндов, показа в быстром меню, отображения папок и HUD-виджетов: отмеченное условие блокирует действие, если стало активным; конфликтующие условия в выборе блокировок становятся недоступными.
