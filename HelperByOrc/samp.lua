...
local entryPoint = {[0x2E2BB7] = {'E', false}, [0x31DF13] = {'R1', false}, [0x3195DD] = {'R2', false}, [0xCC490] = {'R3', false}, [0xCC4D0] = {'R3-1', true}, [0xCBCD0] = {'R4', false}, [0xCBCB0] = {'R4-2', false}, [0xCBC90] = {'R5', false}, [0xFDB60] = {'DL-R1', false}}

module.main_offsets = {
	['SAMP_INFO_OFFSET'] = {['R1'] = 0x21A0F8, ['R2'] = 0x21A100, ['R3-1'] = 0x26E8DC, ['R4'] = 0x26EA0C, ['R4-2'] = 0x26EA0C, ['R5'] = 0x26EB94, ['DL-R1'] = 0x2ACA24},
	['SAMP_DIALOG_INFO_OFFSET'] = {['R1'] = 0x21A0B8 , ['R2'] = 0x21A0C0, ['R3-1'] = 0x26E898, ['R4'] = 0x26E9C8, ['R4-2'] = 0x26E9C8, ['R5'] = 0x26EB50, ['DL-R1'] = 0x2AC9E0},
	['SAMP_DIALOG_ACTIVE_OFFSET'] = {['R1'] = 0x28, ['R2'] = 0x28, ['R3'] = 0x28, ['R3-1'] = 0x28, ['R4'] =0x28 , ['R4-2'] = 0x28, ['R5'] = 0x28, ['DL-R1'] = 0x28},
	['SAMP_DIALOG_ID_OFFSET'] = {['R1'] = 0x30, ['R2'] = 0x30, ['R3'] = 0x30, ['R3-1'] = 0x30, ['R4'] =0x30 , ['R4-2'] = 0x30, ['R5'] = 0x30, ['DL-R1'] = 0x30},
	['SAMP_DIALOG_TEXT_OFFSET'] = {['R1'] = 0x34, ['R2'] = 0x34, ['R3'] = 0x34, ['R3-1'] = 0x34, ['R4'] = 0x34, ['R4-2'] = 0x34, ['R5'] = 0x34, ['DL-R1'] = 0x34},
	['CDialog_Show'] = {['R1'] = 0x6B9C0, ['R2'] = 0x6BA70, ['R3'] = 0x6F8C0, ['R3-1'] = 0x6F8C0, ['R4'] = 0x6FFE0, ['R4-2'] = 0x70010, ['R5'] = 0x6FFB0, ['DL-R1'] = 0x6FA50},
	['CDialog_Close'] = {['R1'] = 0x6C040, ['R2'] = 0x6C0F0, ['R3'] = 0x6FF40, ['R3-1'] = 0x6FF40, ['R4'] = 0x70660, ['R4-2'] = 0x70690, ['R5'] = 0x70630, ['DL-R1'] = 0x700D0},
	['SAMP_DIALOG_CAPTION_OFFSET'] = {['R1'] = 0x40, ['R2'] = 0x40, ['R3'] = 0x40, ['R3-1'] = 0x40, ['R4'] = 0x40, ['R4-2'] = 0x40, ['R5'] = 0x40, ['DL-R1'] = 0x40},
	['CDXUTEditBox_GetText'] = {['R1'] = 0x81030, ['R2'] = 0x810D0, ['R3'] = 0x84F40, ['R3-1'] = 0x84F40, ['R4'] = 0x85680, ['R4-2'] = 0x856B0, ['R5'] = 0x85650, ['DL-R1'] = 0x850D0 },
	['CDXUTEditBox_SetText'] = {['R1'] = 0x80F60, ['R2'] = 0x81000, ['R3'] = 0x84E70, ['R3-1'] = 0x84E70, ['R4'] = 0x855B0, ['R4-2'] = 0x855E0, ['R5'] = 0x85580, ['DL-R1'] = 0x85000},
	...
	['AddEntry'] = {['R1'] = 0x64010, ['R2'] = 0x640E0, ['R3-1'] = 0x67460, ['R4'] = 0x67BA0, ['R4-2'] = 0x67BE0, ['DL-R1'] = 0x067650},
	['RenderEntry'] = {['R1'] = 0x638A0, ['R2'] = 0x640E0, ['R3-1'] = 0x66CF0, ['R4'] = 0x67BA0, ['R5'] = 0x68380, ['DL-R1'] = 0x66EE0},
	['pChat'] = {['R1'] = 0x21A0E4, ['R2'] = 0x21A0EC, ['R3-1'] = 0x26E8C8, ['R4'] = 0x26E9F8, ['R4-2'] = 0x26E9F8, ['DL-R1'] = 0x2ACA10},
	['AddChatMessage'] = {['R1'] = 0x645A0, ['R2'] = 0x64670, ['R3-1'] = 0x679F0, ['R4'] = 0x68130, ['R4-2'] = 0x68070, ['DL-R1'] = 0x67650},

	['CInput'] = {['R1'] = 0x21A0E8, ['R3-1'] = 0x26E8CC, ['R5'] = 0x26EB84, ['DL-R1'] = 0x2ACA14},
	['CInput_Opened'] = {['R1'] = 0x14E0, ['R3-1'] = 0x14E0, ['R5'] = 0x14E0, ['DL-R1'] = 0x14E0},

	['OnResetDevice'] = {['R1'] = 0x64600, ['R2'] = 0x646D0, ['R3-1'] = 0x67A50, ['R4'] = 0x68190, ['R4-2'] = 0x681D0, ['DL-R1'] = 0x67C40},
	...
	['CInput_Send'] = {['R1'] = 0x65C60, ['R2'] = 0x65D30, ['R3-1'] = 0x69190, ['R4'] = 0x698C0, ['R4-2'] = 0x698C0, ['DL-R1'] = 0x69340},
	['CInput_SendSay'] = {['R1'] = 0x57F0, ['R2'] = 0x57e0, ['R3-1'] = 0x5820, ['R4'] = 0x5A00, ['R4-2'] = 0x5A00, ['DL-R1'] = 0x5860},
...
function module.isSAMPInitilizeLua()
	if module.sampModule <= 0 then return false end
	if memory.getint32(module.sampModule + module.main_offsets.SAMP_INFO_OFFSET[module.currentVersion], false) ~= 0 and module.currentVersion ~= 'UNKNOWN' then return true end
	return false
end
...
local GetName = ffi.cast('const char*(__thiscall *)(uintptr_t, unsigned short)', module.sampModule + module.main_offsets.GetName[module.currentVersion])

local getEditboxText = ffi.cast('char*(__thiscall *)(uintptr_t this)', module.sampModule + module.main_offsets.CDXUTEditBox_GetText[module.currentVersion])

local setEditboxText = ffi.cast('void(__thiscall *)(uintptr_t this, char* text, int i)', module.sampModule + module.main_offsets.CDXUTEditBox_SetText[module.currentVersion])

local ID_Find = ffi.cast("int (__thiscall *)(intptr_t, intptr_t)", module.sampModule + module.main_offsets.ID_Find[module.currentVersion])

local CPlayerPool_IsConnected = ffi.cast("bool (__thiscall *)(intptr_t, unsigned short)", module.sampModule + module.main_offsets.CPlayerPool_IsConnected[module.currentVersion])


function module.PedPool()
	local OFFSET_SampInfo = memory.getint32(module.sampModule + module.main_offsets.SAMP_INFO_OFFSET[module.currentVersion], true)
	local OFFSET_SampInfo_pPools = memory.getint32(OFFSET_SampInfo + module.main_offsets.SAMP_INFO_OFFSET_Pools[module.currentVersion], true)
	local OFFSET_SampInfo_pPools_Player = memory.getint32(OFFSET_SampInfo_pPools + module.main_offsets.SAMP_INFO_OFFSET_Pools_Player[module.currentVersion], true)
...
function module.GetNameID(id)
	...
	if nick ~= nil then return ffi.string(nick) else return 'UNKNOWN' end
end
...
function module.sampSetCurrentDialogEditboxTextFix(newstring)
    ...
    ffi.cast("void(__thiscall *)(struct CDXUTEditBox*, const char *, char)", module.sampModule + module.main_offsets.CDXUTEditBox_SetText[module.currentVersion])(st1.m_pEditbox, ffi.cast("const char *", newstring), 0)
end

function module.isDialogActive()
	local isActive = memory.read(module.pDialog_func() + module.main_offsets.SAMP_DIALOG_ACTIVE_OFFSET[module.currentVersion], 4, true)
...
SetCursorMode = ffi.cast('char*(__thiscall *)(uintptr_t, int, bool)', module.sampModule + module.main_offsets.SetCursorMode[module.currentVersion])
...
function module.CDialog_Close_func(int)
	if module.isDialogActive() then
		callMethod(module.sampModule + module.main_offsets.CDialog_Close[module.currentVersion], module.pDialog_func(), 1, 0, int)
	end
end
...
function module.SAMP_DIALOG_ID()
	if module.isDialogActive() then
		return memory.read(module.pDialog_func() + module.main_offsets.SAMP_DIALOG_ID_OFFSET[module.currentVersion], 4, true)
	end
end
...
function module.pCInput_Open_Close(bool)
	local adress = bool and module.main_offsets.CInput_Open[module.currentVersion] or module.main_offsets.CInput_Close[module.currentVersion]
...
function module.sampGetDialogText()
	if module.isDialogActive() then
		local text = memory.read(module.pDialog_func() + module.main_offsets.SAMP_DIALOG_TEXT_OFFSET[module.currentVersion], 4, true)
...
function module.get_dialog_caption()
	if module.isDialogActive() then
		return memory.tostring(module.pDialog_func() + module.main_offsets.SAMP_DIALOG_CAPTION_OFFSET[module.currentVersion])
	end
	return ''
end
...
function module.is_chat_opened()
	local opend_chat = memory.getint32(memory.getint32(module.sampModule + module.main_offsets.CInput[module.currentVersion], false) + 0x14E0, false)
	return opend_chat == 1 and true or false
end

function module.Local_ID()
	return memory.getint16(module.PedPool() + module.main_offsets.SAMP_SLOCALPLAYERID_OFFSET[module.currentVersion], false)
end

function module.getPedID(handle)
	if handle == PLAYER_PED then return true, module.Local_ID() end
...
function module.GetHealthAndArmour(id)
	...
	if id ~= module.Local_ID() then
		local dwRemoteplayer = memory.getint32(module.PedPool() + module.main_offsets.SAMP_PREMOTEPLAYER_OFFSET[module.currentVersion] + id * 4, true)
		if dwRemoteplayer ~= nil then
			local dw_remoteplayer_data = memory.getuint32(dwRemoteplayer + module.main_offsets.SAMP_REMOTEPLAYERDATA_OFFSET[module.currentVersion], true)
			if dw_remoteplayer_data ~= nil then
				fHP = memory.getfloat(dw_remoteplayer_data + module.main_offsets.SAMP_REMOTEPLAYERDATA_HEALTH_OFFSET[module.currentVersion], true)
				fARM = memory.getfloat(dw_remoteplayer_data + module.main_offsets.SAMP_REMOTEPLAYERDATA_ARMOR_OFFSET[module.currentVersion], true)
			end
		end
	else
...
function module.send_chat(text)
	if text == '' or text == nil or text:len() <= 0 then return end
	...
	if text:find('^/') then
		...
		ffi.cast("void (__thiscall*)(uintptr_t, const char*)", module.sampModule + module.main_offsets.CInput_Send[module.currentVersion])(pInput, text)
	else
		ffi.cast("void (__thiscall*)(uintptr_t, const char*)", module.sampModule + module.main_offsets.CInput_SendSay[module.currentVersion])(getCharPointer(PLAYER_PED), text)
	end
end

function module.memoryAddMessageSamp(szText, ulColor)
	if szText == '' or szText == nil or szText:len() <= 0 then szText = 'nil' end
	local szText = tags.change_tags(szText)
	local pChat, szText, ulColor = memory.getint32(module.sampModule + module.main_offsets.pChat[module.currentVersion], true), tostring(szText), tonumber(ulColor)
	return ffi.cast('void(__thiscall*)(uintptr_t, unsigned long, const char*)', module.sampModule + module.main_offsets.AddChatMessage[module.currentVersion])(pChat, ulColor, szText)
end
...
function module.Set_ChatInputText(text, bool)
	...
	if bool then sampSetChatInputEnabled(bool) end
end
