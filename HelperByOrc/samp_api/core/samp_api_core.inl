const SampApi::SampEntryPoint SampApi::entryPoint[SampApi::entryPointCount] = {
    ...
    { 0x3195DD, Version::R2, "R2", false },
    { 0x0CC490, Version::R3, "R3", false },
    { 0x0CC4D0, Version::R3_1, "R3-1", true },
    { 0x0CBCD0, Version::R4, "R4", false },
    { 0x0CBCB0, Version::R4_2, "R4-2", false },
    { 0x0CBC90, Version::R5_2, "R5-2", true },
    { 0x0FDB60, Version::DL_R1, "DL-R1", true },
};

const SampApi::MainOffsets SampApi::main_offsets = {
    // Order inside each VersionedOffset: { R1, R3-1, R5-2, DL-R1 }.
    { 0x21A0F8, 0x26E8DC, 0x26EB94, 0x2ACA24 }, // SAMP_INFO_OFFSET
    { 0x000003C9, 0x0000002C, 0x00000000, 0x0000002C }, // rakclient_interface
    { 0x21A0B8, 0x26E898, 0x26EB50, 0x2AC9E0 }, // SAMP_DIALOG_INFO_OFFSET
    { 0x00000028, 0x00000028, 0x00000028, 0x00000028 }, // SAMP_DIALOG_ACTIVE_OFFSET
    { 0x00000030, 0x00000030, 0x00000030, 0x00000030 }, // SAMP_DIALOG_ID_OFFSET
    { 0x00000034, 0x00000034, 0x00000034, 0x00000034 }, // SAMP_DIALOG_TEXT_OFFSET
    { 0x0006B9C0, 0x0006F8C0, 0x0006FFB0, 0x0006FA50 }, // CDialog_Show
    { 0x0006C040, 0x0006FF40, 0x00070630, 0x000700D0 }, // CDialog_Close
    { 0x00000040, 0x00000040, 0x00000040, 0x00000040 }, // SAMP_DIALOG_CAPTION_OFFSET
    { 0x00081030, 0x00084F40, 0x00085650, 0x000850D0 }, // CDXUTEditBox_GetText
    { 0x00080F60, 0x00084E70, 0x00085580, 0x00085000 }, // CDXUTEditBox_SetText
    { 0x00000024, 0x00000024, 0x00000024, 0x00000024 }, // pDialogInput_pEditBox
    { 0x00000008, 0x00000008, 0x00000008, 0x00000008 }, // pChatInput_pEditBox
    { 0x0000001C, 0x0000001C, 0x0000001C, 0x0000001C }, // CDXUTDialog
    { 0x0009BD30, 0x0009FFE0, 0x000A06F0, 0x000A0530 }, // SetCursorMode
    { 0x21A10C, 0x26E8F4, 0x26EBAC, 0x2ACA3C }, // RefGame
    { 0x00064010, 0x00067460, 0x00067BE0, 0x00067650 }, // AddEntry
    { 0x000638A0, 0x00066CF0, 0x00067470, 0x00066EE0 }, // RenderEntry
    { 0x21A0E4, 0x26E8C8, 0x26EB80, 0x2ACA10 }, // pChat
    { 0x00000020, 0x00000020, 0x00000020, 0x00000020 }, // CHAT_TEXT_OFFSET
    { 0x00000004, 0x00000004, 0x00000004, 0x00000004 }, // CHAT_PREFIX_TEXT_OFFSET
    { 0x000000F4, 0x000000F4, 0x000000F4, 0x000000F4 }, // CHAT_COLOR_OFFSET
    { 0x000000F8, 0x000000F8, 0x000000F8, 0x000000F8 }, // CHAT_PREFIX_COLOR_OFFSET
    { 0x000645A0, 0x000679F0, 0x00068170, 0x00067BE0 }, // AddChatMessage
    { 0x21A0E8, 0x26E8CC, 0x26EB84, 0x2ACA14 }, // SAMP_CHAT_INPUT_INFO_OFFSET
    { 0x000014E0, 0x000014E0, 0x000014E0, 0x000014E0 }, // CInput_Opened (m_bEnabled / opened flag)
    { 0x00064600, 0x00067A50, 0x000681D0, 0x00067C40 }, // OnResetDevice
    { 0x000657E0, 0x00068D10, 0x00069480, 0x00068EC0 }, // CInput_Open
    { 0x000658E0, 0x00068E10, 0x00069580, 0x00068FC0 }, // CInput_Close
    { 0x0006B9FB, 0x0006F8FB, 0x00069580, 0x00068FC0 }, // CInput_Close_fix
    { 0x000636D0, 0x00066B20, 0x000672A0, 0x00066D10 }, // SetPageSize
    { 0x00064A51, 0x00067EB1, 0x00068621, 0x00068091 }, // PageSize_MAX
    { 0x000D7AD5, 0x000E9DB5, 0x000E9E0D, 0x0011BE45 }, // PageSize_StringInfo
    { 0x00065C60, 0x00069190, 0x00069900, 0x00069340 }, // CInput_Send
    ...
    { 0x00000018, 0x00000008, 0x00000004, 0x00000008 }, // SAMP_INFO_OFFSET_Pools_Player
    { 0x0000001C, 0x0000000C, 0x00000000, 0x0000000C }, // SAMP_INFO_OFFSET_Pools_Veh
    { 0x00216378, 0x00151578, 0x00151828, 0x0018F6C0 }, // SAMP_COLOR_OFFSET
    { 0x00010420, 0x00013570, 0x000138C0, 0x000137C0 }, // ID_Find
    { 0x000010B0, 0x000010B0, 0x000010B0, 0x000010B0 }, // CPlayerPool_IsConnected
    { 0x0001B0A0, 0x0001E440, 0x0001EB90, 0x0001E650 }, // IDcar_Find
    { 0x0000002E, 0x00000004, 0x00001F8A, 0x00000026 }, // SAMP_PREMOTEPLAYER_OFFSET
    { 0x00000000, 0x00000000, 0x00000010, 0x00000008 }, // SAMP_REMOTEPLAYERDATA_OFFSET
    { 0x00000000, 0x00000000, 0x00000000, 0x00000004 }, // pSAMP_Actor / remoteData->sampActor
    { 0x000002A4, 0x000002A4, 0x000002A4, 0x000002A4 }, // pGTA_Ped
    { 0x000010B0, 0x000010B0, 0x000010B0, 0x000010B0 }, // IsConnected
    { 0x000001BC, 0x000001B0, 0x000001B0, 0x000001B0 }, // SAMP_REMOTEPLAYERDATA_HEALTH_OFFSET
    { 0x000001B8, 0x000001AC, 0x000001AC, 0x000001AC }, // SAMP_REMOTEPLAYERDATA_ARMOR_OFFSET
    { 0x00084850, 0x00088760, 0x00088E70, 0x000888F0 }, // CDXUTListBox__GetSelectedIndex
    { 0x00086390, 0x0008A2B0, 0x0008A9C0, 0x0008A440 }, // CDXUTListBox__GetItem
    { 0x000863C0, 0x0008A2E0, 0x0008A9F0, 0x0008A470 }, // SAMP_SET_DIALOG_LIST_ITEM_OFFSET
};
