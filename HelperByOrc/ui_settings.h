...
#define APP_UI_TEXTS(X) \
    ...
    X(HudCanvasWidth, "Ширина canvas", "Canvas width") \
    X(HudCanvasHeight, "Высота canvas", "Canvas height") \
