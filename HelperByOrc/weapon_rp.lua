...
M.config = {
  ...
  weapons = {
	...
	-- ARZ кастом
	[71] = { name = "пистолет Desert Eagle Steel", short = "Deagle Steel",        from = "из кобуры",   to = "в кобуру" },
	[72] = { name = "пистолет Desert Eagle Gold", short = "Deagle Gold",        from = "из кобуры",   to = "в кобуру" },
	[73] = { name = "пистолет Glock Gradient", short = "Glock",        from = "из кобуры",   to = "в кобуру" },
	[74] = { name = "пистолет Desert Eagle Flame", short = "Deagle Flame",        from = "из кобуры",   to = "в кобуру" },
	[75] = { name = "револьвер Python Royal", short = "Python R.",        from = "из кобуры",   to = "в кобуру" },
	[76] = { name = "револьвер Python Silver", short = "Python S.",        from = "из кобуры",   to = "в кобуру" },

	[77] = { name = "автомат AK-47 Roses", short = "AK-47 Roses",      from = "со спины",    to = "за спину" },
	[78] = { name = "автомат AK-47 Gold", short = "AK-47 Gold",      from = "со спины",    to = "за спину" },

	[79] = { name = "пулемёт M249 Graffiti",  short = "M249 Graf.",      from = "со спины",    to = "за спину" },
	[80] = { name = "карабин Сайга (золото)",  short = "Сайга Gold",      from = "со спины",    to = "за спину" },
	[81] = { name = "пистолет-пулемёт Standard",  short = "ПП Std.",      from = "с плеча",     to = "на плечо" },
	[82] = { name = "пулемёт M249",  short = "M249",      from = "со спины",    to = "за спину" },
	[83] = { name = "пистолет-пулемёт Skorpion",  short = "Skorpion",      from = "с плеча",     to = "на плечо" },

	[84] = { name = "автомат AKS-74 (камуфляж)",  short = "AKS-74 camo",      from = "со спины",    to = "за спину" },
	[85] = { name = "автомат AK-47 (камуфляж)",  short = "AK-47 camo",      from = "со спины",    to = "за спину" },
	[86] = { name = "дробовик Rebecca",  short = "Rebecca",      from = "со спины",    to = "за спину" },

	[87] = { name = "портальную пушку",  short = "портал-пушку",      from = "со спины",    to = "за спину" },
	[88] = { name = "ледяной меч", short = "ледяной меч", from = "со спины",    to = "за спину" },
	[89] = { name = "портальную пушку",  short = "портал-пушку",      from = "со спины",    to = "за спину" },

	[90] = {		name = "светошумовую гранату", short = "светошум. гранату",	},
	[91] = {		name = "ослепляющую гранату",		short = "ослепл. гранату",	},

	[92] = {	name = "снайперскую винтовку McMillan TAC-50",		short = "TAC-50",      from = "со спины",    to = "за спину"	},
	[93] = {		name = "электрошоковый пистолет",		short = "электрошокер",   from = "из кобуры",   to = "в кобуру"	},
  }
}
