...
[1] = {rpTakeNames={"из-за спины","за спину"},       rpTakeNamesShort={"со спины","за спину"},       verb_map={show={"достал","снял"},        hide={"убрал","повесил"}}},
[2] = {rpTakeNames={"из кармана","в карман"},        rpTakeNamesShort={"из кармана","в карман"},     verb_map={show={"достал","вытащил"},   hide={"убрал","спрятал"}}},
[3] = {rpTakeNames={"с пояса","на пояс"},            rpTakeNamesShort={"с пояса","на пояс"},         verb_map={show={"снял","достал"},      hide={"убрал","вернул"}}},
[4] = {rpTakeNames={"из кобуры","в кобуру"},         rpTakeNamesShort={"из кобуры","в кобуру"},      verb_map={show={"достал","вытащил"},   hide={"убрал","спрятал"}}},
[5] = {rpTakeNames={"из ножен","в ножны"},           rpTakeNamesShort={"из ножен","в ножны"},        verb_map={show={"обнажил","вытащил"}, hide={"вложил","убрал"}}},
[6] = {rpTakeNames={"из подсумка","в подсумок"},     rpTakeNamesShort={"из подсумка","в подсумок"},  verb_map={show={"извлёк","достал"},    hide={"убрал","засунул"}}},
[7] = {rpTakeNames={"с плеча","на плечо"},           rpTakeNamesShort={"с плеча","на плечо"},        verb_map={show={"снял","достал"},      hide={"повесил","убрал"}}},
[8] = {rpTakeNames={"из сумки","в сумку"},           rpTakeNamesShort={"из сумки","в сумку"},        verb_map={show={"достал","вынул"},    hide={"убрал","спрятал"}}},
}

local global_templates = {
adv_show = {"уверенно","быстрым движением","плавно","ловко","легким движением руки"},
adv_hide = {"аккуратно","спокойно","без лишнего шума","коротким движением","бережно"},
...
for _, g in pairs(M.config.rp_guns) do apply_defaults(g) end
...
M.config.rp_guns = {
	...
	[36] = {name="пусковую установку с наведением", enable=true, slot_to_take=1, short="ПУ с навед."},
	...
	[50] = {name="лопасти вертолёта", enable=false, slot_to_take=1, short="лопасти вертолёта"},
	...
	[90] = {name="светошумовую гранату", enable=true, slot_to_take=6, short="светошум. гранату"},
	[91] = {name="ослепляющую гранату",  enable=true, slot_to_take=6, short="ослепл. гранату"},

	[92] = {name="снайперскую винтовку McMillan TAC-50", enable=true, slot_to_take=7, short="TAC-50"},
	[93] = {name="электрошоковый пистолет", enable=true, slot_to_take=4, short="электрошокер"},
}
...
local slot_to_take_fallback = { [0]=2,[1]=1,[2]=4,[3]=7,[4]=7,[5]=7,[6]=7,[7]=1,[8]=6,[9]=8,[10]=8,[11]=2,[12]=2 }
...
local function winfo(id)
        ...
        g = {name=("оружие %d"):format(id), short=("оружие %d"):format(id), enable=true, slot_to_take=get_slot_take_for(id)}
